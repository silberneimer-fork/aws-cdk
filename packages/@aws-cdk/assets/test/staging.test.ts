...
test('base case', () => {
  ...
  expect(stack.resolve(staging.stagedPath)).toEqual('asset.2f37f937c51e2c191af66acf9b09f548926008ec68c575bd2ee54b6e997c0e00');
});
...
test('staging can be disabled through context', () => {
  ...
  expect(staging.sourceHash).toEqual('2f37f937c51e2c191af66acf9b09f548926008ec68c575bd2ee54b6e997c0e00');
  expect(staging.sourcePath).toEqual(sourcePath);
  expect(stack.resolve(staging.stagedPath)).toEqual(sourcePath);
});
